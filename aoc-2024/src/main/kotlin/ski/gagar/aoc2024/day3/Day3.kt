...
object Day3 : Puzzle {
    ...
    override fun part1(input: InputStream): Long = processLines(input.bufferedReader().lineSequence())
    override fun part2(input: InputStream): Long = processText(input.bufferedReader().readText())
}