...
object Day21 : Puzzle {
    ...
    override fun part1(input: InputStream) = findMinWinCost(input.bufferedReader().readText())

    override fun part2(input: InputStream) = findMaxLoseCost(input.bufferedReader().readText())
}