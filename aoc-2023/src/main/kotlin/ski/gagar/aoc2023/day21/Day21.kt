...
object Day21 : Puzzle {
    ...
    override fun part1(input: InputStream) = countCells(input.bufferedReader().lineSequence())
    override fun part2(input: InputStream) = countCellsInf(input.bufferedReader().lineSequence())
}